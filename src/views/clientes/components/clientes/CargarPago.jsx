...
import AddEfectivo from "./metodosPago/AddEfectivo";
import AddChequeIngreso from "./metodosPago/AddCheque";
import AddOtros from "./metodosPago/AddOtros";
import AddTransferencia from "./metodosPago/AddTransferencia";
import { IoMdClose } from "react-icons/io";
import Swal from "sweetalert2";
import axios from "axios";
import { url } from "../../../../common/URL_SERVER";

const CargarPago = ({ setCloseModal, id_cliente, cliente_nombre, fetch }) => {
  ...
  useEffect(() => {
    axios(url + "cliente/pago/" + id_cliente).then(({ data }) => {
      setPagosRealizados(data.pagos);
    });
    ...
    <div className="flex flex-col space-y-2 items-start">
      ...
      <div className="flex space-x-4">
        <div className="space-y-3">
          <div className="flex flex-col">
            ...
            <textarea
              ...
              cols="30"
              rows="10"
              className="bg-white-bg2 text-black p-2 text-lg min-h-[100px] max-h-[200px] w-[400px]"
            ></textarea>
          </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="bg-white-bg2 text-black text-lg h-full w-[400px]">
              ...
              <table className="border-separate text-lg w-full relative">
                ...
                <tbody>
                  {metodosLista.length ? (
                    ...
                    <p className="text-white-bg3 pl-2">
