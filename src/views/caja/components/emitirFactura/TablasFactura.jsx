...
import SeleccionarUM from "./SeleccionarUM";
import SeleccionarIVA from "./SeleccionarIVA";

export const TablaAProductos = ({ prodServFactura, setProdServFactura }) => {
    ...
    return (
        <div className={completados < 6 ? "w-full overflow-hidden" : "w-full scrollbar overflow-auto"}>
            <div className="h-full max-h-56">
                        ...
                        {prodServFactura.map((ps) => (
                            <tr key={ps.id}>
                                ...
                                <td>
                                    <input
                                        type="text"
                                        className="w-full bg-white-bg px-2 rounded-none text-end"
                                        onChange={handleChangeInput}
                                        name="cantidad"
                                        value={ps.cantidad}
                                        id={ps.id}
                                ...
                                <td>
                                    <input
                                        type="text"
                                        className="w-full bg-white-bg px-1 rounded-none"
                                        onChange={handleChangeInput}
                                        name="precio_unidad"
