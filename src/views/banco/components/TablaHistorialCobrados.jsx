...
const TablaHistorialCobrados = ({ cheques, setShowModalHistorial }) => {
  return (
    <div className="h-full sm:min-w-[800px] w-[380px]">
      <div className="w-full flex justify-between">
        <Titulo text="HISTORIAL CHEQUES COBRADOS" />
      </div>
        ...
        <table className="border-separate text-lg w-full relative">
          ...
          <tbody>
            {cheques.length ? (
              ...
              <tr>
                <td colSpan="5" className="text-center py-4 text-black-hover">
                  Aún no hay cheques cobrados.
                </td>
              </tr>
            )}
          </tbody>
...
export default TablaHistorialCobrados;
