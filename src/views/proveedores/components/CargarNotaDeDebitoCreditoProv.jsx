...
const CargarNotasCreditoDebitoProv = ({
  setCloseModal,
  tipo_destinatario,
  id_afectado,
  fetch,
  ...
  const cargarNota = async () => {
    ...
    const resNotas = await axios(url + "proveedor/nota/todo");
    ...
    setLoader(true);
    axios
      .post(url + "proveedor/nota", dataParaEnviar)
      .then((res) => {
        setLoader(false);
        Swal.fire({
    ...
    <div className="flex flex-col space-y-2 items-start">
      ...
      <div className="space-y-3">
        <div className="flex flex-col">
          <label className="labelInput">Tipo<strong className="text-red-400">*</strong></label>
        ...
        <div className="flex flex-col">
          <label className="labelInput">Detalle<strong className="text-red-400">*</strong></label>
          <textarea
        ...
        <div className="flex flex-col">
          <label className="labelInput">Importe<strong className="text-red-400">*</strong></label>
          <div className="bg-white-bg2 text-black pl-5 flex items-center space-x-2">
            ...
            <input
              ...
              name="importe"
              placeholder="Ej: 1000"
              className="bg-white-bg2 text-black p-2 text-xl grow"
            />
          </div>
        </div>
        ...
        <div className="flex justify-end space-x-2">
          ...
          <button onClick={cargarNota} className="boton_verde">
            {loader ? (
              <BiLoaderAlt className="animate-spin text-black-comun text-center " />
            ) : (
              "CARGAR"
            )}
          </button>
...
export default CargarNotasCreditoDebitoProv;
